...
export const isInt64Property = (property: AbstractBaseProperty | AbstractBaseProperty[]): property is Int64Property => !Array.isArray(property) && property.type === 'Int64Property';
