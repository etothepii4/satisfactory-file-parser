...
export const isInt8Property = (property: AbstractBaseProperty | AbstractBaseProperty[]): property is Int8Property => !Array.isArray(property) && property.type === 'Int8Property';
